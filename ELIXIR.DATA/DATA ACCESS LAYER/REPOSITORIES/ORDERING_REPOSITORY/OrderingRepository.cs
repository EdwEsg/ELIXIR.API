...
namespace ELIXIR.DATA.DATA_ACCESS_LAYER.REPOSITORIES.ORDERING_REPOSITORY
{
...

    {
       ...
       private readonly StoreContext _context;
        ...
        public async Task<bool> ValidateCustomer(string CustomerCode, string CustomerName)
        {
            var customer = await _context.Customers
                    .Where(x => (x.CustomerName == CustomerName || x.CustomerCode == CustomerCode) && x.IsActive == true)
                    .FirstOrDefaultAsync();
